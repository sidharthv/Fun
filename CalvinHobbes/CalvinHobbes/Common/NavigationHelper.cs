...
namespace CalvinHobbes.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        RelayCommand navigateToFlipViewPage;
        public RelayCommand NavigateToFlipViewPage
        {
            get
            {
                if (null == navigateToFlipViewPage)
                {
                    navigateToFlipViewPage = new RelayCommand(() =>
                    {
                        var currentFrame = Window.Current.Content as Frame;
                        if (currentFrame != null)
                        {
                            currentFrame.Navigate(typeof(FlipViewPage));
                        }
                    });
                }

                return navigateToFlipViewPage;
            }
            set
            {
                navigateToFlipViewPage = value;
            }
        }
